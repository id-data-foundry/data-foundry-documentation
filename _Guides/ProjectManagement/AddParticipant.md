...
1. **Click on manage resources** on the right of your project page. 

2. In there **click "add participant"** under the tab participants.

3. Depending on your study you can **add one or multiple participants at a time. **Choose one or multiple participants** in the dialog.

4. **Fill in the name of the participant and their email address.** You need to **send the sign-up link** to the participants individually.
