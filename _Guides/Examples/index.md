...
Here you can find examples that showcase various Data Foundry features through design and prototyping projects. Feel free to use these examples in your own work, extend them, or modify them for your specific needs.

## Available Examples

- #### Learn how to upload images from an ESP32 to Data Foundry.
[**ESP32 Camera Upload**]({% link _Guides/Examples/ESP-32/ESP32CameraUpload.md %}){: .btn }
...
[**Experience Sampling**]({% link _Guides/Examples/Integrations/telegram.md %}){: .btn }
