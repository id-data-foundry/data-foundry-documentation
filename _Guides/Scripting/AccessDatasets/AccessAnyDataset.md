...
// timestamps should be converted to milliseconds since epoch like below
var start = new Date('2021-02-15').getTime()
var end = new Date('2021-03-15').getTime()
DF.dataset(2).get('', 20, start, end)
```
...
DF.dataset(2).get('', 20, -1, -1)

// filter results for the time before February 15
DF.dataset(2).get('', 20, -1, start)

// filter results for the time after March 15
DF.dataset(2).get('', 20, end)

// or:
DF.dataset(2).get('', 20, end, -1)
```
